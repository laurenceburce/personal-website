...
async function dispatchCdpMouseClick(page, locator, { timeout = DEFAULT_CLICK_TIMEOUT_MS } = {}) {
  ...
  // CDP input is coordinate-based. Playwright's boundingBox() returns
  // main-frame viewport coordinates even when the locator lives inside an
  // iframe, which matches Input.dispatchMouseEvent's coordinate system.
